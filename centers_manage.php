...
$sql="select a.*, b.title, b.duration, b.total_batches, b.total_no_of_trainees, b.min_qualification from centers a inner join projects b on a.project_id = b.id where 1 $extra and incharge_user_id = '".$_SESSION["logged_in_admin"]["linked_user"]."' order by center";
switch($tab){
	case 'add':
