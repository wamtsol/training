...
<form class="form-horizontal form-horizontal-left" role="form" action="designations_manage.php?tab=edit" method="post" enctype="multipart/form-data" name="frmAdd">
    ...
    <div class="form-group">
    	<div class="row">
            ...
            <div class="col-sm-10">
                <input type="submit" value="Update" class="btn btn-default btn-l" name="designations_edit" title="Update Record" />
            </div>
        </div>
  	</div>
</form>