...
if(numrows($rs)>0){
    ...
    if( !empty( $center_id ) || !empty( $trainee_status_id ) || !empty( $q ) ){
        fputcsv($fh,array('Batch:',  get_field($center_id, "centers","center"), '', 'Status:',  getStatusType($trainee_status_id), '', 'Search:',  $q));
    }
