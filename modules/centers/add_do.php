...
if(isset($_POST["centers_add"])){
	...
	if($err==""){
		$sql="INSERT INTO centers (project_id, district_id, center, incharge_user_id, start_date, end_date) VALUES ('".slash($project_id)."', '".slash($district_id)."', '".slash($center)."', '".slash($incharge_user_id)."', '".date_dbconvert($start_date)."', '".date_dbconvert($end_date)."')";
		doquery($sql,$dblink);
