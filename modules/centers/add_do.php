...
if(isset($_POST["centers_add"])){
	...
	if($err==""){
		$sql="INSERT INTO centers (project_id, district_id, center, duration, min_qualification, incharge_user_id) VALUES ('".slash($project_id)."', '".slash($district_id)."', '".slash($center)."', '".slash($duration)."', '".slash($min_qualification)."', '".slash($incharge_user_id)."')";
		doquery($sql,$dblink);
